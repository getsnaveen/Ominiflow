...
NAME = 'shrinkit'
DESCRIPTION = 'The package that helps to compress everything for ML/AI projects.'
...
REQUIRED = [
    'streamlit', 'pandas', 'numpy', 'scipy', 'scikit-learn', 'ydata-profiling', 'streamlit_ydata_profiling'
]
